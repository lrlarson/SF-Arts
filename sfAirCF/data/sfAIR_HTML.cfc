<cfcomponent>
   ...
   <cffunction name="getActiveVenueAddressesSF" access="remote" returntype="any">
  ...
  <cffunction name="getActiveVenueAddressesTRAVEL" access="remote" returntype="any">
        	<cfstoredproc datasource="sfarts_CFX"  procedure="[procAirEditActiveVenueLocationsWithFILLMORE]"> 
            	<cfprocresult name="recordset1">
            </cfstoredproc>
    <cfreturn recordset1>
  </cffunction> 
  
  <cffunction name="getNewNeighborHoods" access="remote" returntype="Any" >
  	<cfquery name="nabs" datasource="sfarts_CFX" >
  		SELECT     ID AS data, Neighborhood AS label
			FROM         tbl_neighborhoodsNew
			ORDER BY label
  	</cfquery>
  	<cfreturn nabs>
  </cffunction>
  
  <cffunction name="getActiveVenueAddressesSFWithNoDATA" access="remote" returntype="any">
  ...
  <cffunction name="getActiveVenueAddressesTRAVELWithNoDATA" access="remote" returntype="any">
        	<cfstoredproc datasource="sfarts_CFX"  procedure="[procAirEditActiveVenueLocationsWithNODATA_NEW]"> 
            	<cfprocresult name="recordset1">
            </cfstoredproc>
    <cfreturn recordset1>
  </cffunction> 
  
  <cffunction name="getActiveVenueAddressesSFWithNoLAT_LON" access="remote" returntype="any">
  ...
  <cffunction name="getTIXFuzzyLookupBySimilarity" access="remote" returntype="query">
    ...
    <cffunction name="getAddressDetailsForVenue" access="remote" returntype="any">
    	<cfargument name="ID" type="numeric" required="yes">
            ...
            <cfset mystruct.venue_name=#rsDetail.venue_name#>
             ...
             <cfset mystruct.Venue_Neighborhood=#rsDetail.Venue_Neighborhood#>
              <cfset mystruct.neighborhoodNEW=#rsDetail.neighborhoodNEW#>
             <cfset mystruct.lat_lon = #rsDetail.lat_lon#>
             <cfset mystruct.ID = #rsDetail.ID#>
    <cfreturn mystruct>
  </cffunction> 
  
   <cffunction name="getAddressDetailsForVenueTRAVEL" access="remote" returntype="any">
    	<cfargument name="ID" type="numeric" required="yes">
        	<cfstoredproc datasource="sfarts_CFX"  procedure="[procAirGetVenueDetails]"> 
            	<cfprocparam cfsqltype="cf_sql_integer" dbvarname="@id" value="#ID#">
            	<cfprocresult name="rsDetail">
            ...
            <cfset mystruct.venue_name=#rsDetail.venue_name#>
             ...
             <cfset mystruct.Venue_City=#rsDetail.Venue_City#>
             <cfset mystruct.Venue_Zip=#rsDetail.Venue_Zip#>
             <cfset mystruct.Venue_Neighborhood=#rsDetail.neighborhoodNEW#>
             <cfset mystruct.lat_lon = #rsDetail.lat_lon#>
             <cfset mystruct.ID = #rsDetail.ID#>
    <cfreturn mystruct>
  </cffunction> 
    
  <cffunction name="punchInLat_Lon" access="remote" returntype="Any" >
    ...
    <cfargument name="ID" type="numeric" required="yes">
    	...
    	<cfstoredproc datasource="sfarts_CFX" procedure="procAirPunchInlat_longNOZIP">
 ...
 <cffunction name="punchInLat_Lon2" access="remote">
  ...
  <cffunction name="updateVenueData" access="remote" >
        ...
        <cfargument name="Venue_Zip" type="numeric" required="no" default="0">
        <cfargument name="Venue_Neighborhood" type="numeric" required="yes">
         <cfargument name="Venue_Web" type="string" required="no" default="">
...
<cffunction name="updateVenueDataTravel" access="remote" >
    	<cfargument name="ID" type="numeric" required="yes">
        <cfargument name="Venue_Name" type="string" required="yes">
        <cfargument name="Venue_Address" type="string" required="yes">
        <cfargument name="Venue_City" type="string" required="yes">
        ...
        <cfargument name="Venue_Neighborhood" type="numeric" required="yes">
         <cfargument name="Venue_Web" type="string" required="no" default="">
         <cfargument name="newNeighborhood" type="numeric" required="yes">
        
         
            <cfstoredproc datasource="sfarts_CFX"  procedure="[procAirUpdateVenueRecordTravel]"> 
            	<cfprocparam cfsqltype="cf_sql_integer" dbvarname="@id" value="#ID#">
                <cfprocparam cfsqltype="cf_sql_varchar" dbvarname="@Venue_Name" value="#Venue_Name#">
                <cfprocparam cfsqltype="cf_sql_varchar" dbvarname="@Venue_Address" value="#Venue_Address#">
                <cfprocparam cfsqltype="cf_sql_varchar" dbvarname="@Venue_City" value="#Venue_City#">
                ...
                <cfprocparam cfsqltype="cf_sql_integer" dbvarname="@Venue_Neighborhood" value="#Venue_Neighborhood#">
                <cfprocparam cfsqltype="cf_sql_varchar" dbvarname="@Venue_Web" value="#Venue_Web#">
                <cfprocparam cfsqltype="cf_sql_integer" dbvarname="@newNeighborhood" value="#newNeighborhood#">
