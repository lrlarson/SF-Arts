    ...
    <li>
      ...
      <div class="submenu">
        <ul class="menu-list">
          ...
          <li><a href="colophon.cfm" class="side-list-selected">Colophon</a></li>
      ...
      <div id="top-left" class="spot scroll-pane overthrow">
        ...
        <div class="inner">  
         <ul class="side-list">
            ...
            <li><a href="colophon.cfm" class="side-list-selected"><div class="detail title">Colophon</div></a></li>
        ...
        <div id="middle-center" class="spot scroll-pane overthrow">
          ...
          <div class="spothead">
            <div class="navbar actions">
              <ul class="nav">
                ...
                <li class="##"><a href="mailto:?subject=SF/Arts :: Colophon&body=Here is a link to Colophon for SF/Arts.org. The link:http%3A%2F%2Fwww.sfarts.org/colophon.cfm" class="sficon-paper-plane"></a></li>
          ...
          <div class="inner" style="text-align: center;">
            <h2 class="title">Colophon</h2>
              ...
              <h5>SF/Arts is published each month on the last week of the month.</h5>

              <p><u>Send correspondence to:</u><br>
              SF/Arts Media LLC<br>
              870 Market St. #1221<br>
              San Francisco, CA 94102</p>

              <p>On-line event submissions* <a href="http:///www.sfarts.org/addEvent/addEvent.html">here</a><br />
              Email submissions* to: <a href="mailto:sfam@sbcglobal.net">sfam@sbcglobal.net</a><br>
              Advertising inquiries: <a href="mailto:sfam@sbcglobal.net">sfam@sbcglobal.net</a></p>

              <p>*Event submission requirements are available under <a href="submission_policy.cfm">Submission Policy.</a></p>

              <p><u>Publisher</u><br>
              Betsy Crabtree</p>

              <p><u>Calendar Editor</u><br>
              Margo Crabtree</p>

              <h2 class="title">Site Credits</h2>

              <p><u>Project Lead, Back-End Development & Front-End Data Integration</u><br>
              <a href="http://larsonassoc.org">Larson Associates</a>

              <p><u>Front-End Development</u><br>
              <a href="http://zirafaworks.com/">Farsheed Hamidi-Toosi</a>

              <p><u>Art Direction + Design</u><br>
              <a href="http://www.didiergarcia.com">Didier Garcia</a>

              <p>SFArts.org and SF/Arts are underwritten by <a href="http://sfgfta.org/">Grants for the Arts of the San Francisco Hotel Tax Fund</a>, an agency of the City and County of San Francisco.</p>

              <img src="images/gfta-logo.png" width="180"><br><br>
