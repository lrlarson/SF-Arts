    ...
    $.ajax({
        ...
        success: function (d, r, o) {
            if (d !== null) {
                ...
                var seeMoreTemplateScript = $("#seeMoreTemplate").html();
                moreTemplate = Handlebars.compile(seeMoreTemplateScript);
                $("#bottomSeeMore").empty();
                $("#bottomSeeMore").append(moreTemplate(jDataDisp));
