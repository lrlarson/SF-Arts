...
SELECT Event_Table.Event_Name, Venue_Table.Venue_Name, Org_Table.Org_Web,Event_Table.ID,Event_Table.ID2,Venue_Table.Venue_address, 
...
ORDER BY Event_Table.Start_Date;
</cfquery>
<cfscript>
  ...
  <table width="75%" border="1">
    <tr> 
      <td> 
        ...
        <p class="body_address">#Recordset1.Venue_Name#</p>
