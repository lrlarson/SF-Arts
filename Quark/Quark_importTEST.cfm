...
<cfparam name="disp_num" default="#form.disp#">
<cfparam name="Recordset1__disp_num" default="#disp_num#">


<cfquery name="Recordset1" datasource="sfarts_CFX">
SELECT Event_Table.Event_Name, Venue_Table.Venue_Name, Event_Table.ID,Event_Table.ID2,Venue_Table.Venue_address, 
...
ON Org_Table.Org_Num = Event_Table.Org_Num) ON Venue_Table.ID = Event_Table.venueID WHERE ((((Event_Table.Start_Date)<=(now()+#Recordset1__begin_add#)) AND ((Event_Table.End_Date)>=(now()+#Recordset1__end_add#)))AND 
Event_Table.ID=#Recordset1__disp_num#) OR ((((Event_Table.Start_Date) Between 
(now()+#Recordset1__begin_add#) And (now()+#Recordset1__end_add#)))AND Event_Table.ID=#Recordset1__disp_num#) 
...
<CFOUTPUT> 
  <p>begin_date = #begin_date# begin_add = #begin_add# </p>
</CFOUTPUT> <cfoutput query="Recordset1"> 
  <table width="75%" border="1">
    <tr> 
      <td> 
        <p class="Body_Head">#Recordset1.Event_Name#<span class="body_address_last">#Recordset1.Venue_Name#</span><span class="body_address">#Recordset1.Venue_address#</span>, <span class="body_address">#Recordset1.Event_Phone##Recordset1.Date_String#</span>: <span class="body_address">#Recordset1.Time_String#</span><span class="body_address_last">#Recordset1.Ticket_String#</span><span class="body">#Recordset1.Event_Description#</span></p>
        </td>
    </tr>
  </table>
</cfoutput> 
