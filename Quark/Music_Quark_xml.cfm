...
<CFPARAM NAME="form.begin_month" DEFAULT="1">
...
<cfdump var="#toString(musicEvents)#">
<cffile action="write" file="/music.xml" output="#toString(musicEvents)#">
