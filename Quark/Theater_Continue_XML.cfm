...
Event_Table.ID=#Recordset1__disp_num#) and (Event_Table.allowPublish = 1 OR org_table.printException = 1 OR venue_table.venue_zip in (select zip from tbl_AllowedZips))
ORDER BY Event_Table.Event_Name,Event_Table.Start_Date;
</cfquery>
<cfscript>
