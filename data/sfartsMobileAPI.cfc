<cfcomponent>
	...
	<cffunction name="getDisciplines" access="remote" returntype="struct">
		<cfstoredproc datasource="SFARTS_CFX" procedure="[procGetDisciplinesiPhoneAPI]">
        <cfprocresult name="podSubjects">
		</cfstoredproc>
     ...
     <cffunction name="getEditorialContent" access="remote" returntype="any">
     	<cfargument name="Disp_Num" required="false" default="99" type="numeric">
     		<cfif Disp_Num EQ 99> 
        	<cfstoredproc datasource="sfarts_CFX"  procedure="[procEditorialGetItemsiPhoneAPI]"> 
    ...
    <cfreturn objectWrapper>
    <cfelse>
    <cfstoredproc datasource="sfarts_CFX"  procedure="[procEditorialGetItemsiPhoneByDispAPI]"> 
   ...
   <cffunction name="getEventsForEditorialContent" access="remote" returntype="any">
     	<cfargument name="Disp_Num" required="false" default="99" type="numeric">
     		<cfif Disp_Num EQ 99> 
        	<cfstoredproc datasource="sfarts_CFX"  procedure="[procGetEventByEventIDiPhoneEditorialAPI]"> 
            	<cfprocresult name="recordset1">
            </cfstoredproc>
         <cfset arrGirls = QueryToStruct( recordset1 ) />   
           <cfset objectWrapper = structNew()>
    ...
    <cfreturn objectWrapper>
    <cfelse>
    <cfstoredproc datasource="sfarts_CFX"  procedure="[procGetEventByEventIDiPhoneEditorialByDispAPI]"> 
    	<cfprocparam cfsqltype="CF_SQL_INTEGER" dbvarname="@Disp_Num" value="#Disp_Num#">
            	<cfprocresult name="recordset1">
            </cfstoredproc>
         <cfset arrGirls = QueryToStruct( recordset1 ) />   
    ...
    <cfreturn objectWrapper>
     ...
     <cffunction name="getEventsBySimpleStringSearch" access="remote" returntype="any"> <!--- NO dates incolved --->
    	<cfargument name="searchString" type="string" required="yes" default="Piano">
        	...
        	<cfstoredproc datasource="sfartsWebUser"  procedure="procSimpleSearchStringiPhoneAPI"> 
   ...
   <cffunction name="getMasterEventsByDateALL" access="remote" returntype="any">
        ...
        <cfif date1 NEQ date2>
        	...
        	<cfstoredproc datasource="sfarts_CFX"  procedure="[procGetEventRecordsForDateRangePhoneAPI]"> 
          ...
          <cfset objectWrapper = structNew()>
          <cfset objectWrapper.Feedname = 'getMasterEventsByDateALLMultiDay'>
...
SELECT     Event_Table.Event_Num, Event_Table.Date_Difference, ISNULL(Event_Table.Event_Phone, '') AS Event_Phone, dbo.clean_text(Event_Table.Event_Name) 
                      ...
                      'http://www.sfarts.org/share/index.cfm?eventID=' + CAST(Event_Table.Event_Num AS VARCHAR(80)) 
                      AS shareURL
               ...
               <cfset arrGirls = QueryToStruct( baseQuery ) />  
                <cfset objectWrapper = structNew()>
         		 ...
         		 <cfset objectWrapper.date1 = #date1#>
		 		  <cfset objectWrapper.date2 = #date2#>
         		  <cfset objectWrapper.events = #arrGirls#>
         		  <cfset objectWrapper.Feedname = 'getMasterEventsByDateALLOneDay'>
         		  <cfset jsonStatus = insertJSONQuery(objectWrapper.Feedname)>	
      			<cfreturn objectWrapper>
      </cfif>
  </cffunction>    
...
order BY [Discipline List].ID 
   ...
   <cffunction name="getMasterEventsByDateByDisp" access="remote" returntype="any">
        ...
        <cfif date1 NEQ date2>
        	...
        	<cfstoredproc datasource="sfarts_CFX"  procedure="[procGetEventRecordsForDateRangePhoneByDispAPI]"> 
            	<cfprocparam dbvarname="@date1" value="#date1#" cfsqltype="cf_sql_date">
                <cfprocparam dbvarname="@date2" value="#date2#" cfsqltype="cf_sql_date">
          ...
          <cfset objectWrapper.date1 = #date1#>
           ...
           <cfset objectWrapper.events = #arrGirls#>
           <cfset jsonStatus = insertJSONQueryDisp(objectWrapper.Feedname, #Disp_Num#)>	
      <cfreturn objectWrapper>
      <cfelse>
      	<!--- It is a query for a specific date --->
       <!--- set variables for use in the code below --->
...
ORDER BY Event_Table.Date_Difference
    ...
    <cffunction name= "getEventsForThisWeekend" access="remote" returntype="struct">
		...
		<cfif strdayOfWeek EQ 'Monday'>
			...
			<cfstoredproc datasource="sfarts_CFX" procedure="procGetEventsForWeekendForPhoneAPI">
            ...
            <cfset arrGirls = QueryToStruct( XXYYXX ) />  
                <cfset objectWrapper2 = structNew()>
                 ...
                 <cfset objectWrapper2.feedName = 'getEventsForThisWeekend'>     
         		  ...
         		  <cfset jsonStatus = insertJSONQuery(objectWrapper2.Feedname)>	
      			<cfreturn objectWrapper2>
</cffunction>  

     <cffunction name="getEventByEvent_Num" access="remote" returntype="Struct" >  <!--- NO dates involved --->
    	<cfargument name="EVENT_NUM" type="numeric" required="yes">
        	<cfstoredproc datasource="sfartsWebUser"  procedure="procGetEventByEventIDiPhoneAPI"> 
	 ...
	 <cfset jsonStatus = insertJSONQueryEvent_Num(objectWrapper3.Feedname, #EVENT_NUM#)>	
    <cfreturn objectWrapper3>
  </cffunction>
    
    
	<cffunction name="procGetRandomImagesPhoneAPI" access="remote" returntype="Struct" > 
	...
	<cfloop  query="recordset1">
	 ...
	 <cfset objectWrapper3 = structNew()>
		 ...
		 <cfset jsonStatus = insertJSONQuery(objectWrapper3.Feedname)>	
	...
	<cffunction name="insertJSONQuery" access="remote" returntype="Any" >
		<cfargument name="Feedname" type="string" required="true" >
			<cfstoredproc datasource="sfarts_CFX" procedure="procJSONInsertQuery">
				<cfprocparam cfsqltype="CF_SQL_VARCHAR" value="#Feedname#" dbvarname="@feedname">
			</cfstoredproc>
		<cfreturn 'true'>	
	</cffunction>
	
    
      <cffunction name="insertJSONQueryDisp" access="remote" returntype="Any" >
		<cfargument name="Feedname" type="string" required="true" >
        <cfargument name="disp" type="numeric" required="true" >
			<cfstoredproc datasource="sfarts_CFX" procedure="procJSONInsertQueryDisp">
				<cfprocparam cfsqltype="CF_SQL_VARCHAR" value="#Feedname#" dbvarname="@feedname">
                <cfprocparam cfsqltype="cf_sql_integer" value="#disp#" dbvarname="@disp">
			</cfstoredproc>
		<cfreturn 'true'>	
	</cffunction>
    
     <cffunction name="insertJSONQueryEvent_Num" access="remote" returntype="Any" >
		<cfargument name="Feedname" type="string" required="true" >
        <cfargument name="Event_Num" type="numeric" required="true" >
			<cfstoredproc datasource="sfarts_CFX" procedure="procJSONInsertQueryEvent_Num">
				<cfprocparam cfsqltype="CF_SQL_VARCHAR" value="#Feedname#" dbvarname="@feedname">
                <cfprocparam cfsqltype="cf_sql_integer" value="#Event_Num#" dbvarname="@Event_Num">
			</cfstoredproc>
		<cfreturn 'true'>	
	</cffunction>
