    ...
    <li>
      ...
      <div class="submenu">
        <ul class="menu-list">
          ...
          <li><a href="terms_of_use.cfm" class="side-list-selected">Terms of Use</a></li>
        </ul>
      </div>
    </li>
  </ul>
      ...
      <div id="top-left" class="spot scroll-pane overthrow">
        ...
        <div class="inner">  
         <ul class="side-list">
            ...
            <li><a href="terms_of_use.cfm" class="side-list-selected"><div class="detail title">Terms of Use</div></a></li>
          </ul>  
        </div><!-- .inner -->  
      </div><!-- /#top-left -->
          ...
          <div class="spothead">
            <div class="navbar actions">
              <ul class="nav">
                ...
                <li class="##"><a href="mailto:?subject=SF/Arts.org :: Terms of Use&body=Here is a link to more information about SF/Arts' Terms of Use. The link:http%3A%2F%2Fwww.sfarts.org/terms_of_use.cfm.cfm" class="sficon-paper-plane"></a></li>
